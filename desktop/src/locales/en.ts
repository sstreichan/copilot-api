...
const en: Locale = {
  ...
  settings: {
    ...
    proxySystemNote: 'System proxy is used by default. When custom proxy is enabled, Electron and newly started local services use the settings below; restart any running service to apply changes.',
    proxyEnabled: 'Custom proxy',
    proxyEnabledDesc: 'Use http_proxy, https_proxy, and no_proxy from the desktop config',
  ...
  advancedConfig: {
    ...
    modelMappingsDesc: 'Map the requested model name to another target model. The same mappings are shared across supported interfaces, and targets may be regular model IDs or provider/model aliases.',
    scopeLabel: 'Scope',
